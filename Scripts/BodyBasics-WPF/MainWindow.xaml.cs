                ...
                using (DrawingContext dc = this.drawingGroup.Open())
                {
                    ...
                    foreach (Body body in this.bodies)
                    {
                        ...
                        if (body.IsTracked)
                        {
                           ...
                           // CameraSpacePoint LS = body.Joints[JointType.ElbowLeft].Position;
                           // var LSX = LS.X;
                           // var LSY = LS.Y;
                            //var LSZ = LS.Z;
                           // CameraSpacePoint LE = body.Joints[JointType.ElbowLeft].Position;
                           // var LEX = LE.X;
                           // var LEY = LE.Y;
                           // var LEZ = LE.Z;
                          // string writetext = '[' + LEX.ToString() + ',' + LEY.ToString() + ',' + LEZ.ToString() + "]";
                            ...
                            for (int i = 0; i <= 24; i++) 
                            {
                                CameraSpacePoint point = body.Joints[jointTypes[i]].Position;
                                json = json + "[" + point.X.ToString() + "," + point.Y.ToString() + "," + point.Z.ToString() + "],";
